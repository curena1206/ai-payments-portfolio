            ...
            <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 10, padding: 24 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                {[
                  ...
                  { icon: "⇄", color: T.blue, title: "International Flow Consistency", body: `All international payment flows are correctly routed to SWIFT MX — no alternative exists within the current rail set for non-domestic flows. Flow-level cost optimization (Model 03) will provide the next layer of cost intelligence on top of rail selection for these payments.` },
